...
var file = FileChoosers.promptForFile("PNG Overlay",
    FileChoosers.createExtensionFilter("PNG Overlay", "*.png"));
if (file == null) {
    logger.info("No PNG files selected for import");
    return;
}

// Define path to the image file (PNG recommended)
// def path = 'C:/Users/pathology/Documents/Projects/HPylori/HPylori_qupath/heatmap.png'
